    ...
    return(<div>
        <div className="mainbox1">
            <div className="mainbox2"> 
                ...
                <div className="mainbox2d">
                <TextField onChange={takePassword} className="box2d" label="Password" variant="outlined" error={regexObj.PasswordHelperText}  helperText={regexObj.PasswordHelperText} />
                </div>
                ...
                <div className="mainbox2h">
                    <label className="account" style={{color:'blue'}}>Create account</label>
